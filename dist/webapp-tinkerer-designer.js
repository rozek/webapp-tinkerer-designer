var WAD = (function (exports, webappTinkererRuntime) {
    ...
    */
    ...
    var css_248z$i = ".WAD-MessageView.svelte-1dfvlfz{display:block;position:relative;overflow:hidden;height:34px;line-height:34px;text-align:left;border:none;border-top:solid 1px var(--normal-color);padding:0px 34px 0px 4px;white-space:nowrap;text-overflow:ellipsis\n  }.info.svelte-1dfvlfz{color:var(--info-color) }.warning.svelte-1dfvlfz{color:var(--warning-color) }.error.svelte-1dfvlfz{color:#FF4500 }";
  ...
  "><span style="flex:1 1 auto" class="svelte-1oryrio">Globals in XXX</span></div>`;
    ...
    class Button extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { active: 1 });
    	}
    }
    ...
    */
    ...
    function create_if_block$3(ctx) {
    	...
    	function dialog_State_binding(value) {
    		/*dialog_State_binding*/ ctx[16](value);
    	}
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, $InspectorState*/ 131076) {
    ...
    // (125:6) {#if $InspectorState.Pane === 'overview'}
    function create_if_block_6(ctx) {
    	...
    	let current;
    	let if_block0 = /*$InspectorState*/ ctx[2].Mode === "applet" && create_if_block_13();
    	let if_block1 = /*$InspectorState*/ ctx[2].Mode === "master" && create_if_block_12();
    	let if_block2 = /*$InspectorState*/ ctx[2].Mode === "card" && create_if_block_11();
    	let if_block3 = /*$InspectorState*/ ctx[2].Mode === "overlay" && create_if_block_10();
    	let if_block4 = /*$InspectorState*/ ctx[2].Mode === "component" && create_if_block_9();
    	let if_block5 = /*$InspectorState*/ ctx[2].Mode === "import-export" && create_if_block_8();
    	let if_block6 = /*$InspectorState*/ ctx[2].Mode === "search" && create_if_block_7();
    ...
    // (126:8) {#if $InspectorState.Mode === 'applet'}
    ...
    // (127:8) {#if $InspectorState.Mode === 'master'}
    ...
    // (128:8) {#if $InspectorState.Mode === 'card'}
    ...
    // (129:8) {#if $InspectorState.Mode === 'overlay'}
    ...
    // (130:8) {#if $InspectorState.Mode === 'component'}
    ...
    // (131:8) {#if $InspectorState.Mode === 'import-export'}
    ...
    // (132:8) {#if $InspectorState.Mode === 'search'}
    ...
    // (135:6) {#if $InspectorState.Pane === 'selection-globals'}
    ...
    // (136:6) {#if $InspectorState.Pane === 'selection-resources'}
    ...
    // (137:6) {#if $InspectorState.Pane === 'selection-properties'}
    ...
    // (138:6) {#if $InspectorState.Pane === 'selection-configuration'}
    ...
    // (139:6) {#if $InspectorState.Pane === 'selection-script'}
    ...
    // (60:2) <Dialog class="WAD-Inspector" {Applet} Title="WAT-Designer: Inspector" resizable={true}     {PositionAroundPreferredPosition} bind:State={$InspectorState}     minWidth={300} minHeight={420}   >
    function create_default_slot$2(ctx) {
    	...
    	let if_block0 = /*$InspectorState*/ ctx[2].Pane === "overview" && create_if_block_6(ctx);
    	let if_block1 = /*$InspectorState*/ ctx[2].Pane === "selection-globals" && create_if_block_5();
    	let if_block2 = /*$InspectorState*/ ctx[2].Pane === "selection-resources" && create_if_block_4();
    	let if_block3 = /*$InspectorState*/ ctx[2].Pane === "selection-properties" && create_if_block_3$1();
    	let if_block4 = /*$InspectorState*/ ctx[2].Pane === "selection-configuration" && create_if_block_2$1();
    	let if_block5 = /*$InspectorState*/ ctx[2].Pane === "selection-script" && create_if_block_1$1();

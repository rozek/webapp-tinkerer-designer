var WAD = (function (exports, webappTinkererRuntime) {
    ...
    */
    ...
    var css_248z$j = ".WAD-MessageView.svelte-1dfvlfz{display:block;position:relative;overflow:hidden;height:34px;line-height:34px;text-align:left;border:none;border-top:solid 1px var(--normal-color);padding:0px 34px 0px 4px;white-space:nowrap;text-overflow:ellipsis\n  }.info.svelte-1dfvlfz{color:var(--info-color) }.warning.svelte-1dfvlfz{color:var(--warning-color) }.error.svelte-1dfvlfz{color:#FF4500 }";
    ...
    var css_248z$i = ".WAD-SettingsPane.svelte-1qbva1z{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}";
    ...
    var css_248z$h = ".WAD-SelectionScriptPane.svelte-psgudb{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-psgudb{line-height:24px }";
  ...
  "><span style="flex:1 1 auto" class="svelte-psgudb">Script of XXX</span></div>`;
    ...
    var css_248z$g = ".WAD-SelectionConfigurationPane.svelte-1w3olbq{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-1w3olbq{line-height:24px }";
  ...
  "><span style="flex:1 1 auto" class="svelte-1w3olbq">Configuration of XXX</span></div>`;
    ...
    var css_248z$f = ".WAD-SelectionPropertiesPane.svelte-111an29{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-111an29{line-height:24px }";
  ...
  "><span style="flex:1 1 auto" class="svelte-111an29">Props in XXX</span></div>`;
    ...
    var css_248z$e = ".WAD-SelectionResourcesPane.svelte-g1lirl{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-g1lirl{line-height:24px }";
  ...
  "><span style="flex:1 1 auto" class="svelte-g1lirl">Resources in XXX</span></div>`;
    ...
    var css_248z$d = ".WAD-SelectionGlobalsPane.svelte-1oryrio{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-1oryrio{line-height:24px }";
  ...
  "><span style="flex:1 1 auto" class="svelte-1oryrio">Globals in XXX</span></div>`;
    ...
    var css_248z$c = ".WAD-SearchPane.svelte-ifzeo6{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}";
    ...
    var css_248z$b = ".WAD-ImportExportPane.svelte-ej19w1{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}";
    ...
    function create_fragment$d(ctx) {
    	...
    	let button_levels = [/*$$restProps*/ ctx[1], { active: /*active*/ ctx[0] }];
    	let button_data = {};
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	return [active, $$restProps, $$scope, slots, click_handler];
    }
    ...
    var css_248z$9 = ".WAD-ComponentOverviewPane.svelte-zu5cw{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-zu5cw{line-height:24px }";
    ...
    var css_248z$8 = ".WAD-OverlayOverviewPane.svelte-1ng52c9{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-1ng52c9{line-height:24px }";
    ...
    var css_248z$7 = ".WAD-CardOverviewPane.svelte-1xo8bkv{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}span.svelte-1xo8bkv{line-height:24px }";
    ...
    var css_248z$6 = ".WAD-MasterOverviewPane.svelte-1vm3p03{display:flex;position:absolute;flex-flow:column nowrap;width:100%;height:100%;padding:4px}";
    ...
    var css_248z$3 = ".WAD-IconButton.svelte-1d6wotm{display:block;position:absolute;width:32px;height:32px;background:var(--normal-image-url);-webkit-appearance:none;appearance:none;border:none;outline:inherit}.WAD-IconButton.svelte-1d6wotm:not([disabled]):hover,.WAD-IconButton[disabled=\"false\"].svelte-1d6wotm:hover{background:var(--hovered-image-url)}.WAD-IconButton.active.svelte-1d6wotm:not([disabled]):not(:hover),.WAD-IconButton.active[disabled=\"false\"].svelte-1d6wotm:not(:hover){background:var(--active-image-url)}.WAD-IconButton[disabled=\"true\"].svelte-1d6wotm{opacity:0.3 }";
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			toggle_class(button, "svelte-1d6wotm", true);
    		},
    		m(target, anchor) {
    			insert(target, button, anchor);
    		...
    		p(ctx, [dirty]) {
    			set_attributes(button, button_data = get_spread_update(button_levels, [
    				...
    				dirty & /*normalImageURL, active, activeHoveredImageURL, hoveredImageURL, activeImageURL, style*/ 63 && button_style_value !== (button_style_value = "\n  --normal-image-url:url(" + /*normalImageURL*/ ctx[2] + ");\n  --hovered-image-url:url(" + (/*active*/ ctx[0]
    				? /*activeHoveredImageURL*/ ctx[5]
    				: /*hoveredImageURL*/ ctx[3]) + ");\n  --active-image-url:url(" + /*activeImageURL*/ ctx[4] + "); " + /*style*/ ctx[1] + "\n") && { style: button_style_value }
    			]));
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function tintOriginalImage() {
    		$$invalidate(2, normalImageURL = tintedBitmapAsURL(auxImage, normalColor));

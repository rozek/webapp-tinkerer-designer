var WAD = (function (exports, webappTinkererRuntime) {
  ...
  "><span style="flex:1 1 auto" class="svelte-1oryrio">Globals in XXX</span></div>`;
    ...
    var css_248z$2 = ".WAD-Dialog.svelte-2oviqg{display:flex;flex-flow:column nowrap;position:fixed;z-index:10000;overflow:hidden;border:solid 1px #454545;border-radius:8px;background-color:#555555;box-shadow:0px 0px 60px 0px rgba(0,0,0,0.5);font-family:\"Source Sans Pro\",\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:14px;line-height:normal;text-align:left;color:var(--normal-color);pointer-events:auto;-webkit-touch-callout:none;-ms-touch-action:none;touch-action:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.WAD-Titlebar.svelte-2oviqg{display:flex;flex-flow:row nowrap;flex:0 0 auto;position:relative;overflow:hidden;height:24px;min-width:60px;min-height:24px;border-top-left-radius:7px;border-top-right-radius:7px;background-image:linear-gradient(180deg, rgb(128,128,128),rgb(64,64,64) 70%);background-image:-webkit-linear-gradient(270deg, rgb(128,128,128),rgb(64,64,64) 70%);background-clip:border-box;-webkit-background-clip:border-box;cursor:-webkit-grab;cursor:grab}.WAD-Title.svelte-2oviqg{display:inline-block;position:relative;flex:1 1 auto;padding:0px 4px 0px 4px;background-color:transparent;line-height:24px;color:var(--active-color)}.WAD-CloseButton.svelte-2oviqg{display:inline-block;position:relative;flex:0 0 auto;width:24px;height:24px;background-color:transparent;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAhElEQVRIS+2UQQ7AIAgE9bs8iO+24WBiDDIcStomenXdgVXsrXj1Yv92AJjwexGp6jXKExG3kIxm28F82EArhPZHcWnADFnNvQIQYALPyLvVXYSmxUsmSGSeAkSdkPk3AKURkTnNSRhR9BQfeaY0SLSPc5D5BjIanAP8LkFwAJjg/yO6AX98SBk+NsXnAAAAAElFTkSuQmCC\");cursor:pointer}.WAD-CloseButton.svelte-2oviqg:hover{width:24px;height:24px;background-color:transparent;background-image:url(\"data:image/png;base64,\")}.WAD-ContentArea.svelte-2oviqg{display:inline-flex;flex-flow:column nowrap;flex:1 1 auto;position:relative;overflow:hidden;min-height:24px}.WAD-ContentArea.svelte-2oviqg textarea::-webkit-scrollbar{width:10px;height:10px }.WAD-ContentArea.svelte-2oviqg textarea::-webkit-scrollbar-thumb{background-color:#808080;border-radius:4px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.5)}.WAD-ContentArea.svelte-2oviqg textarea::-webkit-scrollbar-track-piece{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-2oviqg textarea::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-2oviqg div::-webkit-scrollbar{width:10px;height:10px }.WAD-ContentArea.svelte-2oviqg div::-webkit-scrollbar-thumb{background-color:#808080;border-radius:4px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.5)}.WAD-ContentArea.svelte-2oviqg div::-webkit-scrollbar-track-piece{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-2oviqg div::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0.1) }.WAD-ResizeHandle.svelte-2oviqg{display:block;position:absolute;right:0px;bottom:0px;width:32px;height:32px;background-image:url(\"data:image/png;base64,\");-webkit-touch-callout:none;-ms-touch-action:none;touch-action:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.WAD-ResizeHandle.svelte-2oviqg:hover{background-image:url(\"data:image/png;base64,\")}";
    ...
    function create_if_block$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			if (if_block) if_block.c();
    			attr(div0, "class", "WAD-Title svelte-2oviqg");
    			attr(div1, "class", "WAD-CloseButton svelte-2oviqg");
    			attr(div2, "class", "WAD-Titlebar svelte-2oviqg");
    			attr(div3, "class", "WAD-ContentArea svelte-2oviqg");
    			set_attributes(div4, div4_data);
    			toggle_class(div4, "WAD-Dialog", true);
    			toggle_class(div4, "svelte-2oviqg", true);
    		},
    		m(target, anchor) {
    ...
    function create_if_block_1$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			create_component(iconbutton.$$.fragment);
    			attr(div, "class", "WAD-ResizeHandle svelte-2oviqg");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);

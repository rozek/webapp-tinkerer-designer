var WAD = (function (exports, webappTinkererRuntime) {
    ...
    */
    ...
    var css_248z$k = ".WAD-MessageView.svelte-1dfvlfz{display:block;position:relative;overflow:hidden;height:34px;line-height:34px;text-align:left;border:none;border-top:solid 1px var(--normal-color);padding:0px 34px 0px 4px;white-space:nowrap;text-overflow:ellipsis\n  }.info.svelte-1dfvlfz{color:var(--info-color) }.warning.svelte-1dfvlfz{color:var(--warning-color) }.error.svelte-1dfvlfz{color:#FF4500 }";
    ...
    function create_fragment$n(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "style", `--normal-color:${normalColor$2};` + `--info-color:${normalColor$2}; --warning-color:${hoveredColor$1}`);
  ...
  "><span style="flex:1 1 auto" class="svelte-1oryrio">Globals in XXX</span></div>`;
    ...
    const normalColor$1 = "#AAAAAA";
    const hoveredColor = "#FFEC2E";
    const activeColor$1 = "#7FFF00"; /* chartreuse */
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	function tintOriginalImage() {
    		$$invalidate(2, normalImageURL = tintedBitmapAsURL(auxImage, normalColor$1));
    		$$invalidate(3, hoveredImageURL = tintedBitmapAsURL(auxImage, hoveredColor));

    		if (activeURL == null) {
    			$$invalidate(4, activeImageURL = tintedBitmapAsURL(auxImage, activeColor$1));
    ...
    // (60:2) <ListView bind:this={AppletListView}     style="flex:1 1 auto; border:solid 1px {normalColor}; padding:2px"     List={$AppletList} Key={(Applet,Index) => Applet.Id}     SelectionLimit={1}     on:selected-item={selectApplet} on:deselected-item={deselectApplet}     let:Item={Applet} let:Index={Index}   >
    function create_default_slot$3(ctx) {
    	let div;
    	let t_value = (/*Applet*/ ctx[8].Id || "Applet #" + /*Index*/ ctx[9]) + "";
    	let t;
    	...
    	return {
    		c() {
    			...
    			set_style(div, "color", /*$selectedAppletList*/ ctx[0].indexOf(/*Applet*/ ctx[8]) < 0
    			? /*Applet*/ ctx[8] === /*$chosenApplet*/ ctx[1]
    				? activeColor
    				: normalColor
    			: "#454545");
    		},
    		...
    		p(ctx, dirty) {
    			if (dirty & /*Applet, Index*/ 768 && t_value !== (t_value = (/*Applet*/ ctx[8].Id || "Applet #" + /*Index*/ ctx[9]) + "")) set_data(t, t_value);

    			if (dirty & /*$selectedAppletList, Applet, $chosenApplet*/ 259) {
    				set_style(div, "color", /*$selectedAppletList*/ ctx[0].indexOf(/*Applet*/ ctx[8]) < 0
    				? /*Applet*/ ctx[8] === /*$chosenApplet*/ ctx[1]
    					? activeColor
    					: normalColor
    ...
    function create_fragment$7(ctx) {
    	...
    	button.$on("click", /*chooseSelection*/ ctx[6]);

    	let listview_props = {
    		style: "flex:1 1 auto; border:solid 1px " + normalColor + "; padding:2px",
    		List: /*$AppletList*/ ctx[4],
    		Key: func,
    		SelectionLimit: 1,
    		$$slots: {
    			default: [
    				create_default_slot$3,
    				({ Item: Applet, Index }) => ({ 8: Applet, 9: Index }),
    				({ Item: Applet, Index }) => (Applet ? 256 : 0) | (Index ? 512 : 0)
    			]
    		},
    		$$scope: { ctx }
    	};
    	...
    	/*listview_binding*/ ctx[7](listview);
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(div1, "dblclick", /*onDoubleClick*/ ctx[5]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, chosable*/ 1032) {
    				button_changes.$$scope = { dirty, ctx };
    			}

    			button.$set(button_changes);
    			const listview_changes = {};
    			if (dirty & /*$AppletList*/ 16) listview_changes.List = /*$AppletList*/ ctx[4];

    			if (dirty & /*$$scope, $selectedAppletList, Applet, $chosenApplet, Index*/ 1795) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, AppletList, $$value => $$invalidate(4, $AppletList = $$value));
    	let AppletListView;
    ...
    var css_248z$2 = ".WAD-Dialog.svelte-11oorsl{display:flex;flex-flow:column nowrap;position:absolute;z-index:10000;overflow:hidden;border:solid 1px #454545;border-radius:8px;background-color:#555555;box-shadow:0px 0px 60px 0px rgba(0,0,0,0.5);font-family:\"Source Sans Pro\",\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:14px;line-height:normal;text-align:left;color:#AAAAAA;pointer-events:auto;-webkit-touch-callout:none;-ms-touch-action:none;touch-action:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.WAD-Titlebar.svelte-11oorsl{display:flex;flex-flow:row nowrap;flex:0 0 auto;position:relative;overflow:hidden;height:24px;min-width:60px;min-height:24px;border-top-left-radius:7px;border-top-right-radius:7px;background-image:linear-gradient(180deg, rgb(128,128,128),rgb(64,64,64) 70%);background-image:-webkit-linear-gradient(270deg, rgb(128,128,128),rgb(64,64,64) 70%);background-clip:border-box;-webkit-background-clip:border-box;cursor:-webkit-grab;cursor:grab}.WAD-Title.svelte-11oorsl{display:inline-block;position:relative;flex:1 1 auto;padding:0px 4px 0px 4px;background-color:transparent;line-height:24px;color:#7FFF00}.WAD-CloseButton.svelte-11oorsl{display:inline-block;position:relative;flex:0 0 auto;width:24px;height:24px;background-color:transparent;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAhElEQVRIS+2UQQ7AIAgE9bs8iO+24WBiDDIcStomenXdgVXsrXj1Yv92AJjwexGp6jXKExG3kIxm28F82EArhPZHcWnADFnNvQIQYALPyLvVXYSmxUsmSGSeAkSdkPk3AKURkTnNSRhR9BQfeaY0SLSPc5D5BjIanAP8LkFwAJjg/yO6AX98SBk+NsXnAAAAAElFTkSuQmCC\");cursor:pointer}.WAD-CloseButton.svelte-11oorsl:hover{width:24px;height:24px;background-color:transparent;background-image:url(\"data:image/png;base64,\")}.WAD-ContentArea.svelte-11oorsl{display:inline-flex;flex-flow:column nowrap;flex:1 1 auto;position:relative;overflow:hidden;min-height:24px}.WAD-ContentArea.svelte-11oorsl textarea::-webkit-scrollbar{width:10px;height:10px }.WAD-ContentArea.svelte-11oorsl textarea::-webkit-scrollbar-thumb{background-color:#808080;border-radius:4px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.5)}.WAD-ContentArea.svelte-11oorsl textarea::-webkit-scrollbar-track-piece{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-11oorsl textarea::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-11oorsl div::-webkit-scrollbar{width:10px;height:10px }.WAD-ContentArea.svelte-11oorsl div::-webkit-scrollbar-thumb{background-color:#808080;border-radius:4px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.5)}.WAD-ContentArea.svelte-11oorsl div::-webkit-scrollbar-track-piece{background-color:rgba(0,0,0,0.1) }.WAD-ContentArea.svelte-11oorsl div::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0.1) }.WAD-ResizeHandle.svelte-11oorsl{display:block;position:absolute;right:0px;bottom:0px;width:32px;height:32px;background-image:url(\"data:image/png;base64,\");-webkit-touch-callout:none;-ms-touch-action:none;touch-action:none;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.WAD-ResizeHandle.svelte-11oorsl:hover{background-image:url(\"data:image/png;base64,\")}";
    ...
    function create_if_block$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			if (if_block) if_block.c();
    			attr(div0, "class", "WAD-Title svelte-11oorsl");
    			attr(div1, "class", "WAD-CloseButton svelte-11oorsl");
    			attr(div2, "class", "WAD-Titlebar svelte-11oorsl");
    			attr(div3, "class", "WAD-ContentArea svelte-11oorsl");
    			set_attributes(div4, div4_data);
    			toggle_class(div4, "WAD-Dialog", true);
    			toggle_class(div4, "svelte-11oorsl", true);
    		},
    		m(target, anchor) {
    ...
    function create_if_block_1$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			create_component(iconbutton.$$.fragment);
    			attr(div, "class", "WAD-ResizeHandle svelte-11oorsl");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    */
    ...
    // (126:6) {#if $InspectorState.Pane === 'overview'}
    ...
    // (127:8) {#if $InspectorState.Mode === 'applet'}
    ...
    // (128:8) {#if $InspectorState.Mode === 'master'}
    ...
    // (129:8) {#if $InspectorState.Mode === 'card'}
    ...
    // (130:8) {#if $InspectorState.Mode === 'overlay'}
    ...
    // (131:8) {#if $InspectorState.Mode === 'component'}
    ...
    // (132:8) {#if $InspectorState.Mode === 'import-export'}
    ...
    // (133:8) {#if $InspectorState.Mode === 'search'}
    ...
    // (136:6) {#if $InspectorState.Pane === 'selection-globals'}
    ...
    // (137:6) {#if $InspectorState.Pane === 'selection-resources'}
    ...
    // (138:6) {#if $InspectorState.Pane === 'selection-properties'}
    ...
    // (139:6) {#if $InspectorState.Pane === 'selection-configuration'}
    ...
    // (140:6) {#if $InspectorState.Pane === 'selection-script'}
    ...
    // (141:6) {#if $InspectorState.Pane === 'settings'}
    ...
    // (62:2) <Dialog class="WAD-Inspector" {Applet} Title="WAT-Designer: Inspector" resizable={true}     {PositionAroundPreferredPosition} bind:State={$InspectorState}     minWidth={300} minHeight={420}   >
    function create_default_slot$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(div1, "border-top", "solid 1px (normalColor)");

var WAD = (function (exports, webappTinkererRuntime) {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			toggle_class(div, "svelte-16u1t1m", true);
    		},
    		m(target, anchor) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	let if_block = /*$chosenApplet*/ ctx[2] !== /*Applet*/ ctx[9] && create_if_block_1(ctx);
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (/*$chosenApplet*/ ctx[2] !== /*Applet*/ ctx[9]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*$chosenApplet*/ ctx[2] !== null && create_if_block(ctx);

var WAD = (function (exports, webappTinkererRuntime) {
    ...
    */
    ...
    // (114:6) {#if $InspectorState.Pane === 'overview'}
    ...
    // (115:8) {#if $InspectorState.Mode === 'applet'}
    ...
    // (118:6) {#if $InspectorState.Pane === 'selection-globals'}
    function create_if_block_8(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (121:6) {#if $InspectorState.Pane === 'selection-resources'}
    function create_if_block_7(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (124:6) {#if $InspectorState.Pane === 'selection-properties'}
    function create_if_block_6(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (127:6) {#if $InspectorState.Pane === 'selection-configuration'}
    function create_if_block_5(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (130:6) {#if $InspectorState.Pane === 'selection-script'}
    function create_if_block_4(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (133:6) {#if $InspectorState.Pane === 'selection-contents'}
    function create_if_block_3$1(ctx) {
    	return { c: noop, m: noop, d: noop };
    }

    // (136:6) {#if $InspectorState.Mode === 'import-export'}
    ...
    // (49:2) <Dialog class="WAD-Inspector" {Applet} Title="WAT-Designer: Inspector" resizable={true}     {PositionAroundPreferredPosition} bind:State={$InspectorState}     minWidth={300} minHeight={420}   >
